...
public class Constants {
    ...
    static public final float[] FRAME_DURATION = {0.1f, 0.08f, 0.03f, 0.8f};
    ...
    static public final String HOME_ICON_INACTIVE_PATH = "PauseScreen/home_inactive.png";
    static public final String HOME_ICON_ACTIVE_PATH = "PauseScreen/home_active.png";
    ...
    static public final String BGMUSIC_ICON_ACTIVE_PATH = "PauseScreen/bgMusic_active.png";
    static public final String BGMUSIC_ICON_INACTIVE_PATH = "PauseScreen/bgMusic_inactive.png";
    ...
    static public final String NEW_GAME_ICON_INACTIVE_PATH = "MainMenuScreen\\white new game.png";
    static public final String EXIT_ICON_INACTIVE_PATH = "MainMenuScreen\\exitInactive.png";
    static public final String EXIT_ICON_ACTIVE_PATH = "MainMenuScreen\\exitActive.png";
    static public final String CREDIT_ICON_ACTIVE_PATH = "MainMenuScreen\\creditActive.png";
    static public final String CREDIT_ICON_INACTIVE_PATH = "MainMenuScreen\\creditInactive.png";
    static public final String GITHUB_INACTIVE_PATH = "credits/github.png";
    static public final String MOBINC_INACTIVE_PATH = "credits/mobinc.png";
    static public final String MOBINC_ACTIVE_PATH = "credits/mobinc_active.png";
    static public final String SETTING_ICON_ACTIVE_PATH = "MainMenuScreen/settings active.png";
